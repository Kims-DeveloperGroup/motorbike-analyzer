...
@Component
@Slf4j
public class NaverDocumentProcessor implements Function<NaverDocumentWrapper, SaleItem> {

    private final NaverDocumentParser naverDocumentParser;

    @Autowired
    public NaverDocumentProcessor(NaverDocumentParser naverDocumentParser) {
